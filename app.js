...
/* Exercise 4 Declare a variable named price using the let keyword, and assign it the value 19.99 (number)
...
/* Exercise 5 Declare a variable named title using the let keyword, and assign it the value "Name of the Wind" (string)
